...
export default function ReviewPage() {
  ...
  return <main className="shell review-page">
    <header className="topbar"><Link className="brand" href="/dashboard"><span className="brand-mark">ع</span><span>Dar<span>Lugha</span></span></Link><Link className="link" href="/dashboard">العودة إلى اللوحة · Dashboard</Link></header>
